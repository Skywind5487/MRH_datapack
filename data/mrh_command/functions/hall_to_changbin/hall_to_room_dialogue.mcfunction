...
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 1 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 2.5s 
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 2 run tellraw @a {"text":"小威:這次我一定要考過"}
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 2 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 2s
...
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 3 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 3.5s
...
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 4 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 4s
...
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 5 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 4s
...
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 6 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 3.7s
...
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 7 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 3.7s
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 8 run tellraw @a {"text":"小威:第一章...史前文化..."}
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 8 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 2
...
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 9 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 0.1s
...
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 10 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 0.1s
...
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 11 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 1.2s
...
execute if score $hall_to_room_dialogue_dialogue hall_to_room_dialogue_dialogue matches 12 run schedule function mrh_command:hall_to_changbin/hall_to_room_dialogue 3.5s
