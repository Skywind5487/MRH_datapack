...
execute if score $hall_to_changbin_dialogue hall_to_changbin_dialogue matches 1 run schedule function mrh_command:hall_to_changbin/hall_to_changbin_dialogue 5s
...
execute if score $hall_to_changbin_dialogue hall_to_changbin_dialogue matches 2 run schedule function mrh_command:hall_to_changbin/hall_to_changbin_dialogue 5s
