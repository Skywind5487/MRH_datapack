...
execute if score $hall_to_changbin_dialogue timer = 2  run tellraw {"text":"Hi here!","bold":"true"} run schedule funtcion mrh_command:hall_to_changbin/test-8-22-2 5s